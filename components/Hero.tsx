        ...
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/5 dark:bg-white/10 backdrop-blur-md text-primary dark:text-accent font-bold text-sm mb-8 border border-primary/10 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute h-full w-full rounded-full bg-magenta opacity-75"></span>
          ...
          <h1 className="text-4xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-slate-900 dark:text-white opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Transformamos organizaciones <br />
            <span className="gradient-text-magenta">a través del talento</span>
          </h1>
          
          <p className="text-lg lg:text-xl text-slate-600 dark:text-slate-300 font-medium mb-12 leading-relaxed max-w-3xl opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex flex-wrap gap-5 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <button 
              ...
              className="btn-gradient text-white px-10 py-5 rounded-full text-lg font-bold shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3"
            >
              Agendar Consultoría
