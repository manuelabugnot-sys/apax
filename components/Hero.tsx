  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden scroll-mt-20 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      <div className="absolute inset-0 z-0">
        {/* Imagen de Equipo - Cambiada para usar tu archivo local si quieres */}
        <img 
      ...
      <div className="max-w-[95%] 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full pt-28 md:pt-40 pb-24 md:pb-32">
        <div className="max-w-4xl">
          {/* Badge superior - Se quitó opacity-0 */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/5 dark:bg-white/10 backdrop-blur-md text-primary dark:text-accent font-bold text-sm mb-8 border border-primary/10 dark:border-white/10 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          {/* Título Principal - Se quitó opacity-0 */}
          <h1 className="text-4xl lg:text-7xl font-display font-extrabold tracking-tight mb-8 leading-[1.1] text-slate-900 dark:text-white drop-shadow-sm animate-fade-in-up transition-colors duration-300" style={{ animationDelay: '0.2s' }}>
            Transformamos organizaciones <br />
            <span className="gradient-text-magenta">a través del talento</span>
          </h1>
          
          {/* Texto secundario - Se quitó opacity-0 */}
          <p className="text-lg lg:text-xl text-slate-600 dark:text-slate-300 font-medium mb-12 leading-relaxed max-w-3xl animate-fade-in-up transition-colors duration-300" style={{ animationDelay: '0.4s' }}>
            Ofrecemos soluciones estratégicas de RRHH que conecten los objetivos organizacionales con la excelencia del equipo.
          </p>
          
          {/* Div de botones - Se quitó opacity-0 */}
          <div className="flex flex-wrap gap-5 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <button 
