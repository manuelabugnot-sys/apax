      ...
      <div className="max-w-[95%] 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full pt-28 md:pt-40 pb-24 md:pb-32">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-wrap gap-5 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            ...
            {/* BOTÓN TALENTO APAX - AHORA CON COLOR Y EFECTO */}
            <button 
              onClick={() => document.getElementById('talento')?.scrollIntoView({ behavior: 'smooth' })}
              className="relative group px-8 py-5 rounded-full text-lg font-bold transition-all flex items-center justify-center gap-2 overflow-hidden border-2 border-magenta/30 hover:border-magenta hover:shadow-[0_0_20px_rgba(157,78,221,0.4)] bg-white/5 dark:bg-white/5"
            >
              <span className="material-symbols-outlined text-magenta group-hover:scale-110 transition-transform">groups</span>
              <span className="bg-gradient-to-r from-primary to-magenta bg-clip-text text-transparent dark:from-white dark:to-magenta">
                Talento Apax
              </span>
            </button>
          </div>
