...
const About: React.FC = () => {
  return (
    /* CORRECCIÓN: Usamos un color estándar de Tailwind (slate-950) 
       o el código hexadecimal para asegurar que el modo oscuro aplique.
    */
    <section id="quienes-somos" className="py-24 bg-white dark:bg-[#020617] transition-colors duration-500 scroll-mt-20">
      <div className="max-w-[95%] 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-8 text-primary dark:text-white tracking-tight">
              Quiénes somos
            </h2>
            <div className="space-y-6 text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-manrope">
              <p>
              ...
              <p className="font-medium italic border-l-4 border-magenta pl-6 py-2 text-slate-800 dark:text-slate-200 bg-slate-50/50 dark:bg-white/5 rounded-r-lg">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-square lg:aspect-video border border-slate-100 dark:border-white/10 group w-full h-full">
              <img 
              ...
              />
              {/* Overlay para que la imagen no brille tanto en modo oscuro */}
              <div className="absolute inset-0 bg-gradient-to-t from-navy/60 dark:from-navy/80 to-transparent opacity-60"></div>
            </div>
          </div>
        </div>
      </div>
