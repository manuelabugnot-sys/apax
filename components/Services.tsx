...
const ServiceCard: React.FC<{
  ...
  <div 
    ...
    className={`group cursor-pointer relative h-full rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 scroll-mt-28 ${featured ? 'md:scale-105 z-10' : ''}`}
  >
    <img 
