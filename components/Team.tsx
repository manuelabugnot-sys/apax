...
const TeamMemberCard: React.FC<{
  ...
  return (
    <div 
      ...
      /* CAMBIO: Se cambió bg-slate-800 por slate-900 y se ajustó el borde para modo oscuro */
...
const Team: React.FC = () => {
  ...
  return (
    /* CAMBIO: Se cambió dark:bg-background-dark por el color hexadecimal de tu marca para evitar errores */
    <section id="equipo" className="py-24 bg-white dark:bg-[#020617] scroll-mt-20 transition-colors duration-500">
          ...
          <div className="relative bg-white dark:bg-slate-900 w-full max-w-5xl max-h-[90vh] rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col md:flex-row animate-scale-up border border-white/10">
            <div className="w-full md:w-2/5 relative h-64 md:h-auto bg-slate-100 dark:bg-slate-800">
              ...
              <div className="absolute bottom-6 left-6 text-white z-20">
                ...
                <h5 className="opacity-90 font-medium tracking-wide uppercase text-sm mt-1">{selectedMember.role}</h5>
              </div>
            </div>
            ...
            <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto custom-scrollbar relative">
              ...
              <div className="space-y-8">
                <div className="relative pl-6">
                  ...
                  <h6 className="text-xs font-black uppercase tracking-widest text-primary dark:text-accent mt-4">Filosofía de Gestión</h6>
                </div>
