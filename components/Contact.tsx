          ...
          <div>
            ...
            <div className="space-y-8 mt-10">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 mt-2">
                    ...
                    >
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <span className="text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-200 flex items-center gap-1.5">
                          <span>🇲🇽</span> Sede México
                        </span>
                        {country === 'MX' && (
                          <span className="text-[10px] bg-[#25d366] text-white px-1.5 py-0.5 rounded-md font-bold">
                            Tu país
                          </span>
                        )}
                      </div>
                      <div className="text-[#25d366] font-bold text-sm sm:text-base hover:underline flex items-center gap-1">
                        <span>{contacts.MX.displayNumber}</span>
                    ...
                    >
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <span className="text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-200 flex items-center gap-1.5">
                          <span>🇦🇷</span> Sede Argentina
                        </span>
                      </div>
                      <div className="text-[#25d366] font-bold text-sm sm:text-base hover:underline flex items-center gap-1">
                        <span>{contacts.AR.displayNumber}</span>
                        <span className="material-symbols-outlined text-xs">open_in_new</span>
                      </div>
                    </a>
                  </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  <h4 className="font-bold text-lg text-primary dark:text-white">Presencia Regional</h4>
                  <div className="space-y-1.5 mt-1 text-slate-600 dark:text-slate-400 text-sm">
                    <p className="flex items-center gap-1.5">
                      <span>🇦🇷</span>
                      <strong className="text-slate-800 dark:text-slate-200">Buenos Aires:</strong> Palermo, CABA, Argentina
                    </p>
                    <p className="flex items-center gap-1.5">
                      <span>🇲🇽</span>
                      <strong className="text-slate-800 dark:text-slate-200">México:</strong> Querétaro & CDMX, México
                    </p>
                  </div>
                </div>
              </div>
